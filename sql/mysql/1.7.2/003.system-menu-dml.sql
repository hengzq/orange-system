...
INSERT INTO sys_menu (id, tenant_id, parent_id, name, permission, preset, path, icon, hidden, sort, created_by)
VALUES (40, @t_id, 1, '字典管理', 'system:dict:view', 0, 'system/dict', 'system-library', 0, 40, @u_id);
...
-- 日志管理
INSERT INTO sys_menu (id, tenant_id, parent_id, name, permission, preset, path, icon, hidden, sort, created_by)
VALUES (50, @t_id, -1, '日志管理', 'system:log', 0, '', 'system-document-text', 0, 50, @u_id);
...
-- 消息管理
INSERT INTO sys_menu (id, tenant_id, parent_id, name, permission, preset, path, icon, hidden, sort, created_by)
VALUES (60, @t_id, -1, '消息管理', 'system:message', 0, '', 'system-notifications', 0, 60, @u_id);

-- 消息模板管理
INSERT INTO sys_menu (id, tenant_id, parent_id, name, permission, preset, path, icon, hidden, sort, created_by)
VALUES (61, @t_id, 60, '消息模板', 'system:message-template:view', 0, 'system-msg/template', 'system-message-template', 0,
        10, @u_id);

INSERT INTO sys_button (id, tenant_id, menu_id, name, permission, preset, sort, created_by)
values (6100, @t_id, 61, '新增', 'system:message-template:create', 0, 1, @u_id),
       (6101, @t_id, 61, '删除', 'system:message-template:delete', 0, 10, @u_id),
       (6102, @t_id, 61, '修改', 'system:message-template:update', 0, 20, @u_id);

-- 消息管理
INSERT INTO sys_menu (id, tenant_id, parent_id, name, permission, preset, path, icon, hidden, sort, created_by)
VALUES (62, @t_id, 60, '消息管理', 'system:msg:view', 0, 'system-msg/message', 'system-notifications', 0, 20, @u_id);


-- 使用文档
INSERT INTO sys_menu (id, tenant_id, parent_id, name, permission, preset, path, icon, hidden, sort, created_by)
VALUES (99, @t_id, -1, '使用文档', 'system:docs:view', 0, 'https://hengzq.cn/community/', 'system-book', 0, 99, @u_id);
COMMIT;
