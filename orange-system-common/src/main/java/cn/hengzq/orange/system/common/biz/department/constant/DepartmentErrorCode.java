...
public interface DepartmentErrorCode extends GlobalErrorCodeConstant {
    String PREFIX = "SystemDepartment.";
    ...
    String DEPARTMENT_NAME_CANNOT_NULL_CODE = PREFIX + "0003";
    ErrorCode ROLE_NAME_CANNOT_NULL = new ErrorCode(DEPARTMENT_NAME_CANNOT_NULL_CODE, "部门名称不能为空");
